...
namespace Akon\Weather;

use Akon\Weather\Exceptions\HttpException;
use Akon\Weather\Exceptions\InvalidArgumentException;
...
class Weather
{
    ...
    public function getWeather($city, string $type = 'base', string $format = 'json')
    {
        ...
        // 1、对 `$format` 与 `$type` 参数进行检查，不在范围内的跑出异常
